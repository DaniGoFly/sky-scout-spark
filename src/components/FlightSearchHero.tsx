...
const FlightSearchHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-visible">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center pt-28 pb-20 px-4 overflow-visible">
        <div className="mx-auto w-full max-w-[1160px] flex-shrink-0 overflow-visible">
