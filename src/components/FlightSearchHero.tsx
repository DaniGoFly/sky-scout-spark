...
const FlightSearchHero = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col overflow-hidden">
      {/* Calm navy gradient — no floating orbs */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(1200px circle at 50% 10%, rgba(47,122,248,0.12), transparent 60%), linear-gradient(180deg, hsl(222 47% 6%), hsl(222 40% 8%))",
        }}
      />
