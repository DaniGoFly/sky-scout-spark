  ...
  if (compact) {
    ...
    return (
      <Popover open={isOpen} onOpenChange={setIsOpen}>
        ...
        <PopoverContent className="w-80 p-4 bg-card z-50" align="start" side="bottom" sideOffset={8} avoidCollisions={false} side="bottom" sideOffset={8} avoidCollisions={false}>
          <PickerContent />
        </PopoverContent>
      </Popover>
    );
